...
Basically, the original <a href="https://github.com/softwareunderground/data-underground/blob/master/open-data-guidelines.md">document</a> in this repo was written towards dataset suppliers, and while that's a worth goal, it bugged me a bit for reasons I initially had a hard time narrowing down. Eventually, I decided the things I felt were left out all hard to do with the fact that the focus was overwelmingly on the dataset.
